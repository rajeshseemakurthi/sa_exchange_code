...
def layout():
    ...
    html.Div([
    html.Div(dcc.DatePickerRange(id='my_date_picker_range_tr',display_format='D-M-Y',min_date_allowed=date(2022, 2, 3),max_date_allowed=obj_datepicker_revisits.current_date(),initial_visible_month=date(2022, 2, 3),start_date=date(2022, 2, 3),end_date=obj_datepicker_revisits.current_date(),style={"position":"relative","display":"inline-block","width":"110%","border-radius":"39px","margin-left":"115%","margin-top":"5%","margin-bottom":"7%"}),style={}),
    ...
    html.A([html.I(className="fa fa-refresh",style={})],href=dash.page_registry['pages.c_revisits']['path'],style={"width":"4%","height":"2.3rem","margin-left":"0.8rem","margin-top":"1.5%","text-align":"center","font-size":"22px","background-color":"rgb(215,215,215)","border-radius":"8px","padding-top":"0.3rem","border":"2px double black"})
...
@app.callback(Output('table_tr','data'),Output('c_tr_error','children'),
    inputs=dict(start_date=Input('my_date_picker_range_tr','start_date'),end_date=Input('my_date_picker_range_tr','end_date')))
