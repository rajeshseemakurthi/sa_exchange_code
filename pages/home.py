...
#Local Imports
from sql_query_fetching import data_frame
...
def layout():
    return html.Div([
            ...
            html.Div([
                dbc.CardImg(src='./assets/image/logo_removebg.png',alt='sanofi_logo',className="sanofi_logo_class"),
                html.P("ver:1.0",className="version_class"),
                html.P("Sanofi Dashboard",className="sanofi_name"),
                dbc.CardImg(src='./assets/image/sehat_ok_please_removebg.png',alt='sehat_logo',className="sehat_logo_class"),
                dbc.CardImg(src='./assets/image/piramal_logo.png',alt='piramal_logo',className="piramal_logo_class"),
                ],className="class_header"),
            #Second Div For Div-Body Class
            html.Div([
                html.Div([
                    dcc.DatePickerRange(id='my_date_picker_range_home',className="calender_class",display_format='DD-MM-Y',min_date_allowed=date(2022, 2, 3),max_date_allowed=obj_home.current_date(),initial_visible_month=obj_home.current_date(),start_date=date(2022, 2, 3),end_date=obj_home.current_date(),style={}),
                    ...
                    html.A([dbc.CardImg(src='./assets/image/refresh_new_removebg.png',alt='refresh_logo',className="refresh_logo_class")],href="/",className="refresh_class"),
                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        html.Div([
                            #Upper Part
                            html.Div([html.P("Clinic's Conducted",className="first_card_upper_part_name")],className="first_card_upper_part"),
                            #Lower Part
                            html.Div([
                                #Total Count
                                ...
                                html.A([dbc.CardImg(src='./assets/image/right_new.png',alt='right_arrow_new',id="right_new_id",className="right_arrow_new_class")],href='/c_clinics_conducted',className="")
                                ],className="first_card_lower_part"),                 
                            ],className="first_card"),
                        #Second Card
                        html.Div([
                            #Upper Part
                            html.Div([html.P("Total Beneficiary Visits",className="second_card_upper_part_name")],className="second_card_upper_part"),
                            #Lower Part
                            html.Div([
                                #Total Count
                                ...
                                html.A([dbc.CardImg(src='./assets/image/right_new.png',alt='right_arrow_new',className="right_arrow_new_class")],href='/c_tbv',className="")
                                ],className="second_card_lower_part"),
                            ],className="second_card"),
                        #Third Card
                        html.Div([
                            #Upper Part
                            html.Div([html.P("Unique Registration's",className="third_card_upper_part_name")],className="third_card_upper_part"),
                            #Lower Part
                            html.Div([
                                #Total Count
                                ...
                                html.A([dbc.CardImg(src='./assets/image/right_new.png',alt='right_arrow_new',className="right_arrow_new_class")],href='/c_unique_registrations',className="")
                                ],className="third_card_lower_part"),                            
                            ],className="third_card"),
                        #Fourth Card
                        html.Div([
                            #Upper Part
                            html.Div([html.P("Revisit's",className="fourth_card_upper_part_name")],className="fourth_card_upper_part"),
                            #Lower Part
                            html.Div([
                                #Total Count
                                ...
                                html.A([dbc.CardImg(src='./assets/image/right_new.png',alt='right_arrow_new',className="right_arrow_new_class")],href='/c_revisits',className="")
                    ...
                    html.Div([
                        ...
                        html.Div([
                            #Upper Part
                            html.Div([html.P("NCD",className="fifth_card_upper_part_name")],className="fifth_card_upper_part"),
                            #Lower Part
                            html.Div([
                                #Total Count
                                ...
                                html.A([dbc.CardImg(src='./assets/image/right_new.png',alt='right_arrow_new',className="right_arrow_new_class")],href='/c_ncd',className="")
                                ],className="fifth_card_lower_part"),  
                            ],className="fifth_card"),
                        #Sixth Card
                        html.Div([
                            #Upper Part
                            html.Div([html.P("NCD Breakup",className="sixth_card_upper_part_name")],className="sixth_card_upper_part"),
                            #Lower Part
                            html.Div([
                                #Hypertension Count
                                ...
                                html.A([dbc.CardImg(src='./assets/image/right_new.png',alt='right_arrow_new',className="right_arrow_new_class")],href='/c_ncd_breakup',className="")
                                ],className="sixth_card_lower_part"),                            
                            ],className="sixth_card"),
                        #Seventh Card
                        html.Div([
                            #Upper Part
                            html.Div([html.P("Test's Conducted",className="seventh_card_upper_part_name")],className="seventh_card_upper_part"),
                            #Lower Part
                            html.Div([
                                #Total Count
                                ...
                                html.A([dbc.CardImg(src='./assets/image/right_new.png',alt='right_arrow_new',className="right_arrow_new_class")],href='/c_tests_conducted',className="")
                                ],className="seventh_card_lower_part"),
                            ],className="seventh_card"),
                        #Eigth Card
                        html.Div([
                            #Upper Part
                            html.Div([html.P("Medicated patients",className="eight_card_upper_part_name")],className="eight_card_upper_part"),
                            #Lower Part
                            html.Div([
                                #Total Count
                                ...
                                html.A([dbc.CardImg(src='./assets/image/right_new.png',alt='right_arrow_new',className="right_arrow_new_class")],href='/c_mp',className="")
